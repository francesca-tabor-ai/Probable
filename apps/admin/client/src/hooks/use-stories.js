    ...
    return useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(api.stories.list.path, { credentials: "include" })];
                    case 1:
                        res = _a.sent();
                        if (!res.ok)
                    ...
                    case 2:
                        data = _a.sent();
                        return [2 /*return*/, api.stories.list.responses[200].parse(data)];
                }
            });
        }); },
    });
...
export function useCreateStory() {
    ...
    return useMutation({
        mutationFn: function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(api.stories.create.path, {
    ...
    return useMutation({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        url = buildUrl(api.stories.update.path, { id: id });
    ...
    return useMutation({
        mutationFn: function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = buildUrl(api.stories.publish.path, { id: id });
                        return [4 /*yield*/, fetch(url, {
    ...
    return useMutation({
        mutationFn: function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = buildUrl(api.stories.delete.path, { id: id });
                        return [4 /*yield*/, fetch(url, {
